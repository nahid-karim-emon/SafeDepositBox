...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($pass != $cpass) {
            ...
            $insert = "INSERT INTO employee(id,name,email,address,phone,nid,password) VALUES(NULL,'$name','$email','$address','$phone','$nid','$pass')";
...
<head>
    ...
    <title>Safe Deposite Box | Employee Registration</title>
            ...
            <div class="authentication-inner">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mb-3 text-center ">Welcome to Employee Registration</h4>
                        ...
                        <form id="registerform" class="mb-3 mt-3" action="" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="nname" class="form-label">NID Number</label>
                                <input type="number" name="nname" required placeholder="enter your NID" class="form-control" id="pname" autofocus />
                            </div>
