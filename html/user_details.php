...
if (isset($_POST['submit'])) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $insert = "INSERT INTO main_users(id,acnum,name,email,firm,address,phone,hair_color,eye_color,height,weight,nid,password) VALUES(NULL,'$rand','$UserName','$UserEmail','$UserFirm','$UserAdd','$UserPhone','$UserHair','$UserEye','$UserHeight','$UserWeight','$UserNid','$UserPassword')";
